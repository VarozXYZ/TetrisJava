...
class TetrisTest {
	...
	void testPieceCanMoveDown() {
		...
		assertTrue(board.canMove(piece, 0, 1), "The piece should be able to move down");
	}
	@Test
	void testPieceCannotMoveOutsideLeft() {
		Tetromino piece = new Tetromino(new Point[] {new Point(0,0), new Point(1,0)}, Color.BLUE);
		assertFalse(board.canMove(piece, -1, 0), "The piece shouldn't be able to move outside the limits (left)");
	}
	@Test
